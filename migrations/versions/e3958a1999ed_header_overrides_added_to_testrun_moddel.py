"""header_overrides added to TestRun moddel

Revision ID: e3958a1999ed
Revises: e212ff73204d
Create Date: 2025-06-17 20:51:44.823628
...
revision = 'e3958a1999ed'
down_revision = 'e212ff73204d'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('test_run', schema=None) as batch_op:
        batch_op.add_column(sa.Column('header_overrides', sa.JSON(), nullable=True))
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('test_run', schema=None) as batch_op:
        batch_op.drop_column('header_overrides')
